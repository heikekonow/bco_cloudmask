function bco_cloudmask_save2netcdf(start_date, end_date)

% clear; close all

filepath = ['/scratch/local1/m300512/bco_concat/Z_' start_date '-' end_date '_closed_concomp.mat'];
outfile = ['~/bco_cloudmask/cloudObjectMask_' start_date '-' end_date '_v0.1.nc'];
outfile_2 = ['~/bco_cloudmask/cloudObjectMask_' start_date '-' end_date '_extradata_v0.1.nc'];
